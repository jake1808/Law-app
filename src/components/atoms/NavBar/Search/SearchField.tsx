...
export const SearchField = () => {
    return (
        <div id='search-box' className='flex justify-center items-center relative'>
            <input type='text' placeholder='Search' className='input input-bordered relative w-[47vw] h-[3.5rem] top-0 bottom-0  bg-white z-90' />
            <button
