        ...
        <ul>
            ...
            <div id='mega-dropdown-menu' className=' block px-6 mega-menu mb-16 sm:mb-0 shadow-xl bg-secondary'>
                <div className='container mx-auto w-full flex flex-wrap justify-between mx-2'>
                    <ul className='px-4 w-full  pb-6 pt-6 lg:pt-3 text-white'>
                        <li className='mb-4'>
                            <form action="" className='w-full flex justify-end items-center relative sm:hidden'>
                        ...
                        <li className='hidden sm:inline-block pl-4 text-xl'>
                            <p><span className='font-medium'>Talk to sales: </span>### ###-####</p>
                        </li>
                    </ul>
                </div>
            </div>
